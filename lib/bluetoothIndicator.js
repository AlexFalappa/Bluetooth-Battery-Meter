...
export const BluetoothIndicator = GObject.registerClass({
    ...
    constructor(settings, device, iconType, widgetInfo) {
        super();
        ...
        this._bin.style_class = 'system-status-icon';
        this._indicator = this._bin;
        ...
        this._idleTimerId = GLib.idle_add(GLib.PRIORITY_LOW, () => {
            if (!this._bin.get_parent())
                return GLib.SOURCE_CONTINUE;
            const node = this._bin.get_theme_node();
    ...
    _addLevelWidget(iconSize) {
        this._bin.disconnectObject(this);
        this._levelWidget = new LevelIconWidget(iconSize, this._iconType, this._widgetInfo);
    ...
    destroy() {
        ...
        this._idleTimerId = null;
        this._levelWidget?.destroy();
        this._levelWidget = null;
